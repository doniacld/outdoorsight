...
// Source: /home/donia/workspace/src/github.com/doniacld/outdoorsight/internal/db/core/db.go
...
func (m *MockDB) Insert(ctx context.Context, collection string, doc interface{}) (interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockDB) Update(ctx context.Context, collection string, filter map[string]interface{}, update bson.D) (int64, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockDB) Delete(ctx context.Context, collection string, filter map[string]interface{}) (int64, error) {
	m.ctrl.T.Helper()
