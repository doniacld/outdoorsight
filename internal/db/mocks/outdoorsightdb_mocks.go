...
func (m *MockDB) AddSpot(ctx context.Context, details db.SpotDetails) error {
	m.ctrl.T.Helper()
...
func (m *MockDB) DeleteSpot(ctx context.Context, spotName string) error {
	m.ctrl.T.Helper()
...
func (m *MockDB) UpdateSpot(ctx context.Context, spotName string, update db.SpotDetails) error {
	m.ctrl.T.Helper()
